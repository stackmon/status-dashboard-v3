...
func (a *API) InitRoutes() {
	...
	{
		v1API.GET("component_status", cache.GinMiddleware(a.componentsCache), v1.GetComponentsStatusHandler(a.db, a.log))
		v1API.POST("component_status",
			AuthenticationMW(a.oa2Prov, a.log, a.secretKeyV1, a.authGroup),
			cache.Invalidator(a.componentsCache),
			v1.PostComponentStatusHandler(a.db, a.log),
		)

		v1API.GET("incidents", cache.GinMiddleware(a.eventsCache), v1.GetIncidentsHandler(a.db, a.log))
	}

	v2API := a.r.Group(v2Group)
	{
		v2API.GET("components", cache.GinMiddleware(a.componentsCache), v2.GetComponentsHandler(a.db, a.log))
		v2API.POST("components", AuthenticationMW(
			a.oa2Prov,
			a.log,
			a.secretKeyV1,
			a.authGroup,
		...
		v2API.GET("components/:id", cache.GinMiddleware(a.componentsCache), v2.GetComponentHandler(a.db, a.log))

		// Incidents section. Deprecated.
		// will be removed in a later version.
		v2API.GET("incidents", cache.GinMiddleware(a.eventsCache), v2.GetIncidentsHandler(a.db, a.log))
		v2API.POST("incidents",
			AuthenticationMW(a.oa2Prov, a.log, a.secretKeyV1, a.authGroup),
			ValidateComponentsMW(a.db, a.log),
			cache.Invalidator(a.eventsCache),
			v2.PostIncidentHandler(a.db, a.log),
		)
		v2API.GET("incidents/:eventID", cache.GinMiddleware(a.eventsCache), v2.GetIncidentHandler(a.db, a.log))
		...
		v2API.GET("events", cache.GinMiddleware(a.eventsCache), v2.GetEventsHandler(a.db, a.log))
		v2API.POST("events",
			AuthenticationMW(a.oa2Prov, a.log, a.secretKeyV1, a.authGroup),
			ValidateComponentsMW(a.db, a.log),
			cache.Invalidator(a.eventsCache),
		...
		v2API.GET("events/:eventID",
			cache.GinMiddleware(a.eventsCache), v2.GetIncidentHandler(a.db, a.log))
		...
		v2API.GET("availability", cache.GinMiddleware(a.componentsCache), v2.GetComponentsAvailabilityHandler(a.db, a.log))
